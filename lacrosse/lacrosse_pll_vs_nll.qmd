...
Download data: [lacrosse_pll_nll_2021-2022.csv](../module_resources/lacrosse_pll_vs_nll/lacrosse_pll_nll_2021-2022.csv)
...
* [lacrosse_pll_nll_2012-2022.csv](../module_resources/lacrosse_pll_vs_nll/lacrosse_pll_nll_2021-2022.csv) - Dataset with game-by-game shots and goals scored for both leagues in the 2021-2022 season.. 

* [lacrosse_pll_vs_nll_t-test_worksheet.docx](../module_resources/lacrosse_pll_vs_nll/lacrosse_pll_vs_nll_t-test_worksheet.docx)- Activity worksheet to compare scoring and shots between indoor and outdoor leagues using t-distributions.

* [lacrosse_pll_vs_nll_randomization_worksheet.docx](../module_resources/lacrosse_pll_vs_nll/lacrosse_pll_vs_nll_randomization_worksheet.docx)- Activity worksheet to compare scoring and shots between indoor and outdoor leagues using randomization tests implements via [StatKey](https://www.lock5stat.com/StatKey/){target="_blank"}.



Sample solutions to the worksheets 

* [lacrosse_pll_vs_nll_t-test_worksheet_key.docx](../module_resources/lacrosse_pll_vs_nll/lacrosse_pll_vs_nll_t-test_worksheet_key.docx) - Activity worksheet using t-distributions with sample solutions. 

* [lacrosse_pll_vs_nll_randomization_worksheet_key.docx](../module_resources/lacrosse_pll_vs_nll/lacrosse_pll_vs_nll_randomization_worksheet_key.docx) - Activity worksheet using randomization tests with sample solutions. 
