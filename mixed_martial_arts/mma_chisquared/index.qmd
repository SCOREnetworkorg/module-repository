...
author:
  ...
  - name: Connor Bryson
    affiliation:
      - ref: baylor
date: July 1, 2024
image: ../../_img/default_thumbnail.png
format:
  html:
...
{{< video https://youtu.be/WAjeMDILtx8 width="500" height="300">}}
...
-   Currently there are 9 [UFC weight classes](https://www.ufc.com/divisions).  From lightest to heaviest with the weight limit for the class:
...
<details>
<summary>Show variable descriptions</summary>
...
b. Which weight class appears more likely to have a KO/TKO/Submission (hint: for which weight classs is the blue bar is higher)?  Does this seem to be a big difference between the weight classes?
